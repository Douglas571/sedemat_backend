...
export interface ApiContribuyenteContribuyente extends Schema.CollectionType {
  ...
  info: {
    singularName: 'contribuyente';
    pluralName: 'contribuyentes';
...
export interface ApiLiquidacionLiquidacion extends Schema.CollectionType {
  collectionName: 'liquidacions';
  info: {
    singularName: 'liquidacion';
    pluralName: 'liquidacions';
...
export interface ApiPagoPago extends Schema.CollectionType {
  ...
  attributes: {
    referencia: Attribute.Integer &
      Attribute.Required &
      Attribute.Unique &
      Attribute.DefaultTo<0>;
    monto: Attribute.Decimal;
    liquidacion: Attribute.Relation<
      'api::pago.pago',
      'oneToOne',
      'api::liquidacion.liquidacion'
    >;
